  ...
  run: async (client, m, args, usedPrefix, command) => {
    ...
    try {
      if (isPinterestUrl) {
        ...
        // Mensaje header antes del álbum
        ...
        await client.sendMessage(m.chat, {
          ...
          contextInfo: {
            ...
            forwardedNewsletterMessageInfo: {
              ...
              serverMessageId: '0',
              newsletterName: settings?.nameid || 'Kurumi Protocol'
            },
            externalAdReply: {
              title: settings?.namebot || 'Kurumi Protocol',
              body: 'Kurumi Search 🩸',
              mediaType: 1,
              thumbnailUrl: settings?.icon || '',
        ...
        // Álbum deslizable
        const medias = results.slice(0, 10).map((r, i) => ({
          ...
          contextInfo: {
            externalAdReply: {
              ...
              body: 'Kurumi Search 🩸',
              mediaType: 1,
              thumbnailUrl: 'https://d.uguu.se/zogPFyQC.jpg',
              sourceUrl: `https://pinterest.com/search/pins/?q=${encodeURIComponent(text)}`,
              renderLargerThumbnail: false
            }
          }
        }))
