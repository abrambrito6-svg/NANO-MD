...
export default {
  ...
  run: async (client, m, args, usedPrefix, command) => {
    try {
      ...
      const botName = db.settings[botId]?.namebot || 'Kurumi-MD'; 

      // 🦾 Personalización 100% tuya, limpia y con saltos hacia abajo 🥀
let texto1 = `『⛧|🜸Wixoss🪴Ruka's-BOT』`
let texto2 = `
┃ |🜸BOT
┃ ╰ BACCHI-BOT🪴
...
━━━━━━━━━━━━━━━
 *「Aquí no entra la luz...」*
 *𝙕𝙖𝙘𝙠 𝙘𝙤𝙧𝙩𝙖 • 𝙍𝙖𝙘𝙝𝙚𝙡 𝙧í𝙚* 👁️🔪`
