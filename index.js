...
console.log(chalk.bgHex('#000000').hex('#FF0000').bold(` B6 `) + chalk.white(` Banner: ${chalk.hex('#8B0000')('SATÁNICO')} | Zack: ${chalk.red('SIN DIOS')} | Rachel: ${chalk.cyan('APROBADO')} | Estado: ${chalk.hex('#FF4500')('HELL MODE')} 🔥⛧`))
console.log(
chalk.hex('#FFD700')(`
╭──────────────────────────────────────────────╮
│ ✦ Creator : Abram                           │
